<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagePayOnline.aspx.cs" Inherits="bonita_mazamitla.pagoEnLinea" %>
        ...
        <!-- row -->
            ...
            <div class="alert-danger">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title">Reservación </h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="auto-style10">
                            <asp:Label ID="lblstate" runat="server" Text="" CssClass="auto-style11"></asp:Label>
                            <form action="" class="tm-signup-form">
                                ...
                                <div class="auto-style5">
                                    ...
                                    <asp:Label ID="lblDATEInitial" runat="server" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
                                ...
                                <div class="auto-style9">
                                    ...
                                    <asp:Label ID="LabelTypePay" runat="server" Text="" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
                                    <asp:TextBox ID="txttipoPago" runat="server" class="form-control" placeholder="Tipo de pago" Width="722px"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <br />
                                    Menores<br />
                                        <asp:Label ID="LabelMEnor" runat="server" Text="" Font-Bold="True" ForeColor="#FF3300"></asp:Label>
                                     <br />
                                    </label>
                                ...
                                <div class="form-group">
                                    <label for="password">
                                        Adultos
                                        <asp:Label ID="LabelAdult" runat="server" Text="" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </label>
