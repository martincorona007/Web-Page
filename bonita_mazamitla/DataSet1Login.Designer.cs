...
namespace bonita_mazamitla {
    ...
    public partial class DataSet1Login : global::System.Data.DataSet {
        ...
        public partial class usuarioDataTable : global::System.Data.TypedTableBase<usuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public usuarioRow AddusuarioRow(string nombre, string contrasenia, string p_apellido, string s_apellido, string correo, string telefono, System.DateTime fecha_registro) {
...
namespace bonita_mazamitla.DataSet1LoginTableAdapters {
    ...
    public partial class usuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuario] ([nombre], [contrasenia], [p_apellido], [s_apellido]," +
                " [correo], [telefono], [fecha_registro]) VALUES (@nombre, @contrasenia, @p_apell" +
                "ido, @s_apellido, @correo, @telefono, @fecha_registro)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[usuario] SET [nombre] = @nombre, [contrasenia] = @contrasenia, [p_a" +
                "pellido] = @p_apellido, [s_apellido] = @s_apellido, [correo] = @correo, [telefon" +
                "o] = @telefono, [fecha_registro] = @fecha_registro WHERE (([ID_user] = @Original" +
                "_ID_user))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_user, nombre, contrasenia, p_apellido, s_apellido, correo, telefono, fe" +
                "cha_registro FROM dbo.usuario";
        ...
        public virtual int Fill(DataSet1Login.usuarioDataTable dataTable) {
        ...
        public virtual DataSet1Login.usuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1Login.usuarioDataTable dataTable = new DataSet1Login.usuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1Login.usuarioDataTable dataTable) {
        ...
        public virtual int Insert(string nombre, string contrasenia, string p_apellido, string s_apellido, string correo, string telefono, System.DateTime fecha_registro) {
            if ((nombre == null)) {
            ...
            if ((p_apellido == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(p_apellido));
            }
            if ((s_apellido == null)) {
                throw new global::System.ArgumentNullException("s_apellido");
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(s_apellido));
            }
            if ((correo == null)) {
        ...
        public virtual int Update(string nombre, string contrasenia, string p_apellido, string s_apellido, string correo, string telefono, System.DateTime fecha_registro, int Original_ID_user) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((p_apellido == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(p_apellido));
            }
            if ((s_apellido == null)) {
                throw new global::System.ArgumentNullException("s_apellido");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(s_apellido));
            }
            if ((correo == null)) {
                throw new global::System.ArgumentNullException("correo");
            }
